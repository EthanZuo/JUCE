...
namespace BinaryData
{
    ...
    const int           cello_wavSize = 67920;

    extern const char*  cello_1_wav;
    const int           cello_1_wavSize = 8518;

    extern const char*  cello_2_wav;
    const int           cello_2_wavSize = 467664;

    extern const char*  cello_3_wav;
    const int           cello_3_wavSize = 343888;
